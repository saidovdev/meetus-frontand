    ...
    <div className="min-h-screen flex flex-col bg-white text-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button onClick={()=>navigate(router.selectType)}  className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-2">
                  {t('hero.primaryButton')}
      ...
      <section className="py-16 md:py-24 bg-blue-600 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button onClick={()=>navigate(router.selectType)} className="px-8 py-4 bg-white text-blue-600 hover:bg-blue-50 font-semibold rounded-lg transition-colors duration-200">
            {t('cta.button')}
          </button>
        </div>
      </section>
